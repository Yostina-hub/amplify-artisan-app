...
import { Loader2, Search, Filter, Download, Shield } from "lucide-react";
...
export default function CompanyAuditLog() {
  ...
  const fetchLogs = async () => {
    try {
      ...
      // Fetch audit logs for company users
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = `company-audit-log-${format(new Date(), "yyyy-MM-dd")}.csv`;
    a.click();
  };
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Activity log for all users in your company
          </p>
        </div>
